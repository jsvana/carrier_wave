...
struct DescriptionLookup {
    ...
    private static let dxccEntities: [(prefixes: [String], entity: DXCCEntity)] = [
        ...
        (["K", "W", "N", "AA", "AB", "AC", "AD", "AE", "AF", "AG", "AH", "AI", "AJ", "AK", "AL"], DXCCEntity(number: 291, name: "United States")),

        // Canada
        (["VE", "VA", "VY", "VO", "CY", "CZ"], DXCCEntity(number: 1, name: "Canada")),

        // Mexico
        (["XE", "XA", "XB", "XC", "XD", "XF", "4A", "4B", "4C", "6D", "6E", "6F", "6G", "6H", "6I", "6J"], DXCCEntity(number: 50, name: "Mexico")),
        ...
        (["DL", "DA", "DB", "DC", "DD", "DF", "DG", "DH", "DI", "DJ", "DK", "DM", "DO", "DP", "DQ", "DR"], DXCCEntity(number: 230, name: "Germany")),
        ...
        (["SM", "SA", "SB", "SC", "SD", "SE", "SF", "SG", "SH", "SI", "SJ", "SK", "SL", "7S", "8S"], DXCCEntity(number: 284, name: "Sweden")),
        (["LA", "LB", "LC", "LD", "LE", "LF", "LG", "LH", "LI", "LJ", "LK", "LL", "LM", "LN"], DXCCEntity(number: 266, name: "Norway")),
        ...
        // Russia & Former USSR
        (["UA", "RA", "R", "UA1", "UA3", "UA4", "UA6", "RK", "RN", "RU", "RV", "RW", "RX", "RZ"], DXCCEntity(number: 15, name: "European Russia")),
        ...
        (["UR", "US", "UT", "UU", "UV", "UW", "UX", "UY", "UZ", "EM", "EN", "EO"], DXCCEntity(number: 288, name: "Ukraine")),
        ...
        // Asia
        (["JA", "JD", "JE", "JF", "JG", "JH", "JI", "JJ", "JK", "JL", "JM", "JN", "JO", "JP", "JQ", "JR", "JS", "7J", "7K", "7L", "7M", "7N", "8J", "8K", "8L", "8M", "8N"], DXCCEntity(number: 339, name: "Japan")),
        ...
        (["BY", "BA", "BD", "BG", "BH", "BI", "BJ", "BL", "BT", "BZ", "3H", "3I", "3J", "3K", "3L", "3M", "3N", "3O", "3P", "3Q", "3R", "3S", "3T", "3U", "XS"], DXCCEntity(number: 318, name: "China")),
        (["VU", "AT", "AU", "AV", "AW", "AX", "VT", "VV", "VW", "8T", "8U", "8V", "8W", "8X", "8Y"], DXCCEntity(number: 324, name: "India")),
        ...
        (["YB", "YC", "YD", "YE", "YF", "YG", "YH", "7A", "7B", "7C", "7D", "7E", "7F", "7G", "7H", "7I", "8A", "8B", "8C", "8D", "8E", "8F", "8G", "8H", "8I"], DXCCEntity(number: 327, name: "Indonesia")),
        (["DU", "DV", "DW", "DX", "DY", "DZ", "4D", "4E", "4F", "4G", "4H", "4I"], DXCCEntity(number: 375, name: "Philippines")),
        ...
        // South America
        (["PY", "PP", "PQ", "PR", "PS", "PT", "PU", "PV", "PW", "PX", "ZV", "ZW", "ZX", "ZY", "ZZ"], DXCCEntity(number: 108, name: "Brazil")),
        (["LU", "AY", "AZ", "L2", "L3", "L4", "L5", "L6", "L7", "L8", "L9", "LO", "LP", "LQ", "LR", "LS", "LT", "LV", "LW"], DXCCEntity(number: 100, name: "Argentina")),
    ...
    static func dxccEntity(for callsign: String) -> DXCCEntity? {
        ...
        for length in [3, 2, 1] {
            guard base.count >= length else { continue }
